...
class ToolCaller:
    ...
    def __init__(self, ollama_url: str = "http://192.168.2.68:11434",
...
示例:
  ...
  python goai_agent.py --topic "化学平衡移动" --difficulty 高中
    ...
    parser.add_argument("--ollama-url", default="http://192.168.2.68:11434", help="Ollama地址")
