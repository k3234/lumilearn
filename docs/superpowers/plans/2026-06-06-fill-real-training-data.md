...
- 服务器: 192.168.2.63，14GB RAM，无 GPU
...
BASE_MODEL = "/home/kai/.cache/modelscope/qwen/Qwen2___5-3B-Instruct"
...
将 `scripts/generate_responses.py` 通过 SFTP 上传到 `/home/kai/lumilearn/scripts/generate_responses.py`，然后运行：
