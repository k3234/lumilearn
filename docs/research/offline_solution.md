...
# 2. 测试本地模型
curl http://192.168.2.xx:11434/api/generate \
...
# 现在可以通过 http://192.168.2.xx:8080/v1/chat/completions 访问
```
...
LLAMA_CPP_BASE = "http://192.168.2.xx:8080/v1"
...
# 4. 测试
curl http://192.168.2.xx:8080/v1/models
```
