...
```python
# 添加 A 记录到天虹服务器
dm.add_a_record("lumilearn.digitalplat.org", "192.168.2.63")
...
输出示例：
```
主站: lumilearn.pages.dev → 192.168.2.63
API: api.lumilearn.pages.dev → 192.168.2.63:11434
终端: terminal.lumilearn.pages.dev → 192.168.2.63:18080
```
...
# 配置 DNS
dm.add_a_record(domain, "192.168.2.63")
dm.add_subdomain("api", domain, "192.168.2.63:11434")
dm.add_subdomain("terminal", domain, "192.168.2.63:18080")
