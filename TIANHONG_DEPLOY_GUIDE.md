...
| 服务 | 地址 | 说明 |
|------|------|------|
| **统一网关** | http://192.168.2.xx:11435 | 推荐使用，自动路由 |
| V4 API | http://192.168.2.xx:11436 | V4直连 |
| Ollama | http://192.168.2.xx:11437 | Ollama直连 |
...
def call_v4(prompt):
    url = "http://192.168.2.xx:11435/api/generate"
...
```bash
# 查看模型
curl http://192.168.2.xx:11435/api/tags

# 调用V4
curl http://192.168.2.xx:11435/api/generate -d '{"model":"lumilearn-v4-skills","prompt":"你好"}'
```
...
```powershell
# 设置环境变量
$env:OLLAMA_HOST = "192.168.2.xx:11437"

# 或修改统一网关配置
$env:OLLAMA_URL = "http://192.168.2.xx:11437"
```
