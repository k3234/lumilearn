...
# 注意：192.168.2.63:18080 是 Flask 前端，不提供 /api/generate。
# 实际的本地 LLM 推理由 Ollama 提供（http://192.168.2.63:11434）。
...
DEFAULT_OLLAMA_BASE = "http://192.168.2.63:11434"
...
def generate_slides(topic: str, slide_count: int = 5, style: str = "detailed") -> list:
    ...
    ollama_base = _os.environ.get("OLLAMA_BASE_URL", "http://192.168.2.63:11434")
